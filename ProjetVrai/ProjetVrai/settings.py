...
MEDIA_ROOT=os.path.join(BASE_DIR,'ProjetVrai/imgMateriel')

MEDIA_URL="/img/"

STATIC_URL = '/assets/'
STATICFILES_DIRS=[os.path.join(BASE_DIR,"ProjetVrai/assets")]


TEMPLATES[0]['DIRS']=[os.path.join(BASE_DIR,"ProjetVrai/templates")]
